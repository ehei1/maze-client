...
public:
    ...
    */
    ...
    void getPositionAndNormal( OgreNewt::Body* body, Ogre::Vector3& pos, Ogre::Vector3& norm ) const { NewtonMaterialGetContactPositionAndNormal(m_material, &pos.x, &norm.x); }

    //! get the tangent vectors of the collision
    void getTangentDirections( OgreNewt::Body* body, Ogre::Vector3& dir0, Ogre::Vector3& dir1 ) const { NewtonMaterialGetContactTangentDirections(m_material, &dir0.x, &dir1.x); }
